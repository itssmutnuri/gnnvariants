...
for variant in variant_names:
    ...
    for d in dates: # retrospective dates
        try:
            ...
            preproc_time = pre_end - pre_start
...
mean_preproc = np.mean(preproc_times)
mean_train = np.mean(training_times)
mean_eval = np.mean(eval_times)

# Open the file in write mode
with open("timed.txt", 'w') as file:
    # Write the lists to the file
    file.write("Preproc: " + str(preproc_times) + "\n")
    file.write("Training: " + str(training_times) + "\n")
    file.write("Eval: " + str(eval_times) + "\n")

    # Write the variables to the file
    file.write("Mean Preproc: " + str(mean_preproc) + "\n")
    file.write("Mean Training: " + str(mean_train) + "\n")
    file.write("Mean Eval: " + str(mean_eval) + "\n")