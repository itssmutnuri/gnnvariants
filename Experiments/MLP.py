...
for pango in all_variants:
    ...
    for d in dates:
        ...
        clf = MLPClassifier(hidden_layer_sizes=(16, 8), max_iter=100, activation='relu', solver='adam', random_state=42)
        ...
        append_to_csv(filepath, [CF, cost_1, 0, 0, [], d, []], header=header)
        # Evaluate the model
        #accuracy = accuracy_score(y_test, y_pred)
        print(f"MLP f1: {cost_1}")
